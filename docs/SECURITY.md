...
5. **RBAC & Authorization**: Server-side role enforcement on every API route (`admin`, `referent`, `user`). Scope isolation for referents restricted strictly to their assigned zone members.
