...
import { Search, Filter, Shield, ShieldCheck, Plus, Upload, Download, X } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-3 lg:gap-6">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button
              ...
              title="Cliquer pour changer de mode (Consultation / Administrateur)"
            >
              {userRole === 'admin' ? (
                <>
